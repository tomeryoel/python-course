...
# -----------------------------------------------
# 2ï¸ Define Level 1: Approval Router
# -----------------------------------------------
...
# -----------------------------------------------
# 3ï¸ Define Level 2: If Approved â†’ Risk Evaluation
# -----------------------------------------------
...
# -----------------------------------------------
# 4ï¸ Define Level 2: If Rejected â†’ Reason Classification
# -----------------------------------------------
...
# -----------------------------------------------
# 5ï¸ Define Level 3: Detailed Explanations for Each Leaf
# -----------------------------------------------
...
def loan_decision_tree(query: str):
    ...
    if "approve" in decision:
        ...
        print("â“ Unknown outcome.")

    print("-" * 70)


# -----------------------------------------------
# 7ï¸ Test the Full Decision Flow
# -----------------------------------------------
